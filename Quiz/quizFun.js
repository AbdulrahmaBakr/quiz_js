...
let question = document.querySelector(".quiz") //3-quiz area created to put the title in it
...
// function rightOrWrong(right,choosen){
// //     console.log(`ra  :${right}`)
// //    console.log(`ca  :${chooser}`)
// // console.log(createBullet)
// if(right == choosen ){
//     createBullet.className = 'on'
// }else{
//     createBullet.className = 'onwrong'
// }
// }

//full progress bar with one click 
// function increassProgress(){
// var i = 0;
 
//   if (i == 0) {
//     i = 1;
//     var elem = document.getElementById("progss");
//     var width = 10;
